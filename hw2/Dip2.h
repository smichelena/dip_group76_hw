...
enum NoiseType {
  NOISE_TYPE_1, /// Mysterious noise type 1 (look at the pictures, we won't tell
                /// you what it is)
  NOISE_TYPE_2, /// Mysterious noise type 2 (look at the pictures, we won't tell
                /// you what it is)
  NUM_NOISE_TYPES
};
...
/**
 * @brief Denoising, with parameters specifically tweaked to the two noise
 * types.
 * @note: Figure out reasonable denoising parameters for each algorithm-noise
 * combination.
 */
cv::Mat_<float>
